...
/**
 * Abstract adapter, for particular gateway implementation services to implement.
 *
 */
abstract class System_Service_Payment_Adapter_AbstractAdapter
{
	 ...
	 * class matching the method.  If a method is not found, the currently
	 * active API will be called directly.
	 *
	 ...
	 *
	 * @param array $options
	 * @return System_Service_Payment_AdapterAbstract
	 */
