 ...
 * 
 */
abstract class System_Service_PayPal_Api_AbstractApi
{
    /**
     * The adapter used to send requests.
     * 
     * @var System_Service_PayPal_Adapter_AbstractAdapter
     */
    protected $_adapter;
     ...
     * Constructor.
     * 
     * @param System_Service_PayPal_Adapter_AbstractAdapter $adapter 
     * 
     */
    public function __construct( System_Service_PayPal_Adapter_AbstractAdapter $adapter )
    {
