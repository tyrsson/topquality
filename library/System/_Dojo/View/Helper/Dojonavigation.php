 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class System_Dojo_View_Helper_DojoNavigation
    extends Zend_View_Helper_Navigation_HelperAbstract
{
     ...
     * @var string
     */
    const NS = 'System_Dojo_View_Helper_Navigation';
     ...
     *                                               self
     */
    public function dojonavigation(Zend_Navigation_Container $container = null)
    {
        if (null !== $container) {
