 ...
 */
class System_Controller_Action_Helper_Acl extends Zend_Controller_Action_Helper_Abstract
{
    /**
     * @var Zend_Acl
     */
     ...
     * @return System_Controller_Helper_Acl
     */
    public function setIdentity($identity)
    {
        if (is_array($identity)) {
        	...
        	//FIXME: class will not be found
            throw new System_Exception('Invalid identity provided');
        }
